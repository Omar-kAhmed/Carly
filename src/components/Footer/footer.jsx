...
function Footer() {
  ...
  <p className="Address">Thomas Mann Ut 41, Debrecen, Hungary, Europe</p> <i className="icon-location"></i>
      <p className="email">pixel@mailbox.unideb.hu</p> <i className="icon-envelope"></i>
      <p className="phone ">+36202984780</p> <i className="icon-phone"></i>



<div className="contact"> 
      <a href="https://www.facebook.com" className="icon-facebook icon"></a>
      <a href="https://www.instagram.com" className="icon-instagram-with-circle icon"></a>
      <a href="https://www.linkedin.com/in/omar-k-ahmed/" className="icon-linkedin-with-circle icon"></a>
      <a href="https://x.com/?lang=en" className="icon-twitter-with-circle icon"></a>
